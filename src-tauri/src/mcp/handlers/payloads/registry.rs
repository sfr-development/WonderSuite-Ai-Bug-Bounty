...
pub fn sources_for(category: &str) -> Vec<PayloadSource> {
    match category {
        "sqli" => vec![
            ...
            sl(
                "sqli",
                "sqli-auth-bypass2.txt",
                "SQL Injection/Intruder/Auth_Bypass2.txt",
                "SQLi auth bypass variant 2",
            ),
            sl(
                "sqli",
            ...
            sl(
                "sqli",
                "sqli-mysql-fuzzdb.txt",
                "SQL Injection/Intruder/FUZZDB_MYSQL.txt",
            ...
            sl(
                "sqli",
                "sqli-mssql-enum.txt",
                "SQL Injection/Intruder/FUZZDB_MSSQL_Enumeration.txt",
                "MSSQL enumeration",
            ),
            sl(
                "sqli",
            ...
            sl(
                "sqli",
                "sqli-oracle-fuzzdb.txt",
                "SQL Injection/Intruder/FUZZDB_Oracle.txt",
                "Oracle-specific payloads",
            ),
            sl(
                "sqli",
                "sqli-postgres-enum.txt",
                "SQL Injection/Intruder/FUZZDB_Postgres_Enumeration.txt",
                "PostgreSQL enum",
            ),
        ...
        "xss" => vec![
            ...
            sec(
                "xss",
                "xss-robot-jhaddix.txt",
                "Fuzzing/XSS/robot-friendly/XSS-Jhaddix.txt",
                "Robot-friendly Jhaddix",
            ),
            sec(
                "xss",
                "xss-robot-fuzzing.txt",
                "Fuzzing/XSS/robot-friendly/XSS-Fuzzing.txt",
                "Robot-friendly XSS fuzzing",
            ),
            sec("xss", "xss-polyglots.txt", "Fuzzing/XSS/Polyglots/XSS-Polyglots.txt", "XSS polyglots"),
            sec(
                "xss",
                "xss-polyglot-0xsobky.txt",
            ...
            sl(
                "xss",
                "xss-patt-alert.txt",
                "XSS Injection/Intruders/xss_alert.txt",
                "PATT XSS alert payloads",
            ),
            sl(
                "xss",
                "xss-patt-identifiable.txt",
                "XSS Injection/Intruders/xss_alert_identifiable.txt",
                "Identifiable XSS",
            ),
            sl(
                "xss",
            ...
            sl(
                "xss",
                "xss-patt-polyglots.txt",
                "XSS Injection/Intruders/XSS_Polyglots.txt",
                "PATT XSS polyglots",
            ),
            sl(
                "xss",
                "xss-patt-brutelogic.txt",
            ...
            sl(
                "xss",
                "xss-patt-mario.txt",
                "XSS Injection/Intruders/MarioXSSVectors.txt",
                "Mario XSS vectors",
            ),
        ],
        ...
        "lfi" => vec![
            ...
            sl(
                "lfi",
                "lfi-dotslash.txt",
                "File Inclusion/Intruders/dot-slash-PathTraversal_and_LFI_pairing.txt",
                "Dotslash traversal",
            ),
            sl(
                "lfi",
        ...
        "ldap" => vec![
            ...
            sl(
                ...
                "PATT LDAP small fuzz",
            ),
            sl(
                "ldap",
                "ldap-patt-attrs.txt",
                "LDAP Injection/Intruder/LDAP_attributes.txt",
        ...
        "auth" => vec![
            sec(
                "auth",
                "common-passwords-top10k.txt",
                "Passwords/Common-Credentials/10k-most-common.txt",
                "Top 10k passwords",
            ),
            sec(
                "auth",
                "common-passwords-darkweb.txt",
                "Passwords/Common-Credentials/darkweb2017_top-10000.txt",
                "Darkweb top 10000",
            ),
            sec(
                "auth",
                "common-passwords-top100.txt",
                "Passwords/Common-Credentials/darkweb2017_top-100.txt",
                "Darkweb top 100",
            ),
            sec(
                "auth",
                "common-passwords-top1000.txt",
                "Passwords/Common-Credentials/darkweb2017_top-1000.txt",
                "Darkweb top 1000",
            ),
        ],
        ...
        "fuzzing" => vec![
            ...
            sec(
                "fuzzing",
                "environment-ids.txt",
                "Fuzzing/environment-identifiers.txt",
                "Environment identifiers",
            ),
            sl(
                "fuzzing",
                "springboot-actuator.txt",
                "Insecure Management Interface/Intruder/springboot_actuator.txt",
                "SpringBoot actuator",
            ),
        ],
